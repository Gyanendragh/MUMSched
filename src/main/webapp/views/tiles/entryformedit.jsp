...
<div align="center">
	...
	<form:form modelAttribute="editEntry" method="post">
		<table>
			...
			<tr>
				<td>Entry Year</td>
				<td><form:input path="entryYear" type="text"
						value="${editEntry.entryYear}" /></td>
			...
			<tr>
				...
				<td><form:input path="noOfFppStudents" type="text"
						value="${editEntry.noOfFppStudents}" /></td>
				<td><form:errors path="noOfFppStudents" cssStyle="color:red;"></form:errors>
				</td>
			</tr>
			<tr>
				<td>Number of MPP Students</td>
				<td><form:input path="noOfMppStudents" type="text"
						value="${editEntry.noOfMppStudents}" /></td>
				<td><form:errors path="noOfMppStudents" cssStyle="color:red;"></form:errors>
				</td>
			</tr>
			<tr>
				<td>Number of US Resident</td>
				<td><form:input path="noOfUsResident" type="text"
						value="${editEntry.noOfUsResident}" /></td>
